...
VL_MODULE(VInsMem) {
  public:
    ...
    VL_IN8(clock,0,0);
    VL_IN8(reset,0,0);
    VL_IN16(io_wrAdder,9,0);
    VL_OUT(io_rData,31,0);
    
    // LOCAL SIGNALS
    // Internals; generally not touched by application code
    VL_SIG(InsMem__DOT__mem___05FT_11_data,31,0);
  ...
  public:
    ...
    static void	_combo__TOP__4(VInsMem__Syms* __restrict vlSymsp);
  private:
    void	_configure_coverage(VInsMem__Syms* __restrict vlSymsp, bool first);
  ...
  public:
    ...
    static void	_settle__TOP__3(VInsMem__Syms* __restrict vlSymsp);
    ...
    static void	traceChgThis__3(VInsMem__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
