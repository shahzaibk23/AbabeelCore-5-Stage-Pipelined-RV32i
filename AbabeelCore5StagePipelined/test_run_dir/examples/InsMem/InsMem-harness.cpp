...
#endif
#include <iostream>
class InsMem_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    InsMem_api_t(VInsMem* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VInsMem* top = new VInsMem;
    std::string vcdfile = "test_run_dir/examples/InsMem/InsMem.vcd";
