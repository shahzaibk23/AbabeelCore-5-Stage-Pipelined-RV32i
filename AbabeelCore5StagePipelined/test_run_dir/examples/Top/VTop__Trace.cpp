...
void VTop::traceChgThis__2(VTop__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBit  (c+2,(((0x33U != (0x7fU & vlTOPp->Top__DOT__ifId__DOT__reg_ins)) 
			     & (IData)(vlTOPp->Top__DOT__control__DOT__ID_io_Load))));
	vcdp->chgBit  (c+3,(vlTOPp->Top__DOT__control__DOT__CD_io_RegWrite));
...
void VTop::traceChgThis__3(VTop__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus  (c+25,((0x1fU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				       >> 0xfU))),5);
	vcdp->chgBus  (c+26,((0x1fU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				       >> 0x14U))),5);
	vcdp->chgBus  (c+27,(vlTOPp->Top__DOT__memWr__DOT__reg_rd),5);
	vcdp->chgBus  (c+28,(((0x1fU == (0x1fU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
						  >> 0xfU)))
			       ? vlTOPp->Top__DOT__regFile__DOT__registers_31
			       : ((0x1eU == (0x1fU 
					     & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
									...
									((3U 
									 ...
									 ((2U 
									  ...
									  ((1U 
									    ...
									    ? vlTOPp->Top__DOT__regFile__DOT__registers_1
									    : vlTOPp->Top__DOT__regFile__DOT__registers_0)))))))))))))))))))))))))))))))),32);
	vcdp->chgBus  (c+29,(vlTOPp->Top__DOT__ifId__DOT__reg_ins),32);
	vcdp->chgBus  (c+30,(((((0x80000000U & vlTOPp->Top__DOT__ifId__DOT__reg_ins)
				 ? 0xfffffU : 0U) << 0xcU) 
				 ...
				 | ((0x7e0U & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				    ...
				    | (0x1fU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
						>> 7U)))))),32);
	vcdp->chgBus  (c+31,((IData)((VL_ULL(0x7fffffffffff) 
				      & ((QData)((IData)(
							 ((((0x80000000U 
							     & vlTOPp->Top__DOT__ifId__DOT__reg_ins)
							     ? 0xfffU
							  ...
							  | (0xfffffU 
								...
								>> 0xcU))))) 
					 << 0xcU)))),32);
	vcdp->chgBus  (c+32,(((((0x80000000U & vlTOPp->Top__DOT__ifId__DOT__reg_ins)
				 ? 0xfffffU : 0U) << 0xcU) 
			      | (0xfffU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
					   >> 0x14U)))),32);
	vcdp->chgBus  (c+33,((7U & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				    >> 0xcU))),3);
	vcdp->chgBit  (c+34,((1U & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				    >> 0x1eU))));
	vcdp->chgBus  (c+35,(vlTOPp->Top__DOT__idExe__DOT__reg_operandA),32);
	vcdp->chgBus  (c+36,(vlTOPp->Top__DOT__idExe__DOT__reg_operandB),32);
	vcdp->chgBus  (c+37,(vlTOPp->Top__DOT__idExe__DOT__reg_aluCtrl),5);
	vcdp->chgBus  (c+38,(((IData)(4U) + vlTOPp->Top__DOT__Pc__DOT__reg__024)),32);
	vcdp->chgBus  (c+39,(vlTOPp->Top__DOT__Pc__DOT__reg__024),32);
	vcdp->chgBus  (c+40,((0x3ffU & (vlTOPp->Top__DOT__Pc__DOT__reg__024 
					>> 2U))),10);
	vcdp->chgBus  (c+41,((0xffU & (vlTOPp->Top__DOT__exeMem__DOT__reg_aluOutput 
				       >> 2U))),10);
	vcdp->chgBus  (c+42,(vlTOPp->Top__DOT__exeMem__DOT__reg_strData),32);
	vcdp->chgBit  (c+43,(vlTOPp->Top__DOT__exeMem__DOT__reg_memWrite));
	vcdp->chgBit  (c+44,(vlTOPp->Top__DOT__exeMem__DOT__reg_memToReg));
	vcdp->chgBus  (c+45,(vlTOPp->Top__DOT__ifId__DOT__reg_pc),32);
	vcdp->chgBus  (c+46,(vlTOPp->Top__DOT__ifId__DOT__reg_pc4),32);
	vcdp->chgBus  (c+47,((0x1fU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				       >> 7U))),5);
	vcdp->chgBit  (c+48,(vlTOPp->Top__DOT__idExe__DOT__reg_memWrite));
	vcdp->chgBit  (c+49,(vlTOPp->Top__DOT__idExe__DOT__reg_memToReg));
	vcdp->chgBus  (c+50,(vlTOPp->Top__DOT__idExe__DOT__reg_rd),5);
	vcdp->chgBus  (c+51,(vlTOPp->Top__DOT__idExe__DOT__reg_strData),32);
	vcdp->chgBus  (c+52,(vlTOPp->Top__DOT__exeMem__DOT__reg_rd),5);
	vcdp->chgBus  (c+53,(vlTOPp->Top__DOT__exeMem__DOT__reg_aluOutput),32);
	vcdp->chgBit  (c+54,(vlTOPp->Top__DOT__memWr__DOT__reg_memToReg));
	vcdp->chgBus  (c+55,(vlTOPp->Top__DOT__memWr__DOT__reg_dataOut),32);
	vcdp->chgBus  (c+56,(vlTOPp->Top__DOT__memWr__DOT__reg_aluOutput),32);
	vcdp->chgBit  (c+57,((0x33U == (0x7fU & vlTOPp->Top__DOT__ifId__DOT__reg_ins))));
	vcdp->chgBus  (c+58,(vlTOPp->Top__DOT__regFile__DOT__registers_0),32);
	vcdp->chgBus  (c+59,(vlTOPp->Top__DOT__regFile__DOT__registers_1),32);
	vcdp->chgBus  (c+60,(vlTOPp->Top__DOT__regFile__DOT__registers_2),32);
	vcdp->chgBus  (c+61,(vlTOPp->Top__DOT__regFile__DOT__registers_3),32);
	vcdp->chgBus  (c+62,(vlTOPp->Top__DOT__regFile__DOT__registers_4),32);
	vcdp->chgBus  (c+63,(vlTOPp->Top__DOT__regFile__DOT__registers_5),32);
	vcdp->chgBus  (c+64,(vlTOPp->Top__DOT__regFile__DOT__registers_6),32);
	vcdp->chgBus  (c+65,(vlTOPp->Top__DOT__regFile__DOT__registers_7),32);
	vcdp->chgBus  (c+66,(vlTOPp->Top__DOT__regFile__DOT__registers_8),32);
	vcdp->chgBus  (c+67,(vlTOPp->Top__DOT__regFile__DOT__registers_9),32);
	vcdp->chgBus  (c+68,(vlTOPp->Top__DOT__regFile__DOT__registers_10),32);
	vcdp->chgBus  (c+69,(vlTOPp->Top__DOT__regFile__DOT__registers_11),32);
	vcdp->chgBus  (c+70,(vlTOPp->Top__DOT__regFile__DOT__registers_12),32);
	vcdp->chgBus  (c+71,(vlTOPp->Top__DOT__regFile__DOT__registers_13),32);
	vcdp->chgBus  (c+72,(vlTOPp->Top__DOT__regFile__DOT__registers_14),32);
	vcdp->chgBus  (c+73,(vlTOPp->Top__DOT__regFile__DOT__registers_15),32);
	vcdp->chgBus  (c+74,(vlTOPp->Top__DOT__regFile__DOT__registers_16),32);
	vcdp->chgBus  (c+75,(vlTOPp->Top__DOT__regFile__DOT__registers_17),32);
	vcdp->chgBus  (c+76,(vlTOPp->Top__DOT__regFile__DOT__registers_18),32);
	vcdp->chgBus  (c+77,(vlTOPp->Top__DOT__regFile__DOT__registers_19),32);
	vcdp->chgBus  (c+78,(vlTOPp->Top__DOT__regFile__DOT__registers_20),32);
	vcdp->chgBus  (c+79,(vlTOPp->Top__DOT__regFile__DOT__registers_21),32);
	vcdp->chgBus  (c+80,(vlTOPp->Top__DOT__regFile__DOT__registers_22),32);
	vcdp->chgBus  (c+81,(vlTOPp->Top__DOT__regFile__DOT__registers_23),32);
	vcdp->chgBus  (c+82,(vlTOPp->Top__DOT__regFile__DOT__registers_24),32);
	vcdp->chgBus  (c+83,(vlTOPp->Top__DOT__regFile__DOT__registers_25),32);
	vcdp->chgBus  (c+84,(vlTOPp->Top__DOT__regFile__DOT__registers_26),32);
	vcdp->chgBus  (c+85,(vlTOPp->Top__DOT__regFile__DOT__registers_27),32);
	vcdp->chgBus  (c+86,(vlTOPp->Top__DOT__regFile__DOT__registers_28),32);
	vcdp->chgBus  (c+87,(vlTOPp->Top__DOT__regFile__DOT__registers_29),32);
	vcdp->chgBus  (c+88,(vlTOPp->Top__DOT__regFile__DOT__registers_30),32);
	vcdp->chgBus  (c+89,(vlTOPp->Top__DOT__regFile__DOT__registers_31),32);
	vcdp->chgBit  (c+90,((1U & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				    >> 7U))));
	vcdp->chgBus  (c+91,((0xfU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				      >> 8U))),4);
	vcdp->chgBus  (c+92,((0xffU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				       >> 0xcU))),8);
	vcdp->chgBit  (c+93,((1U & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				    >> 0x14U))));
	vcdp->chgBus  (c+94,((0xfU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				      >> 0x15U))),4);
	vcdp->chgBus  (c+95,((0x3fU & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				       >> 0x19U))),6);
	vcdp->chgBit  (c+96,((1U & (vlTOPp->Top__DOT__ifId__DOT__reg_ins 
				    >> 0x1fU))));
	vcdp->chgBus  (c+97,(vlTOPp->Top__DOT__dataMem__DOT__dMem___05FT_20_addr_pipe_0),10);
	vcdp->chgBit  (c+98,(((~ (IData)(vlTOPp->Top__DOT__exeMem__DOT__reg_memToReg)) 
...
void VTop::traceChgThis__4(VTop__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit  (c+99,(vlTOPp->clock));
	vcdp->chgBit  (c+100,(vlTOPp->reset));
	vcdp->chgBus  (c+101,(vlTOPp->io_main_RegOut),32);
    }
}
